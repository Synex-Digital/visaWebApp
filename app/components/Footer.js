  ...
  return (
    <footer className={`${pathName === "/form" ? "hidden" : "block"}`}>
      <div className="max-w-container mx-auto px-2">
        <div className="flex flex-col md:flex-row gap-6 text-center md:text-start border-b-2 border-primary pb-20">
          <div className="text-primary w-full flex flex-col items-center md:items-start">
            <MyImage
              source="/assets/Logos/footerLogo.png"
              alt="footerLogo.png"
              className="w-28"
            />
        ...
        <div>
          <h6 className="text-center my-10 text-primaryGreen1shade2">
            Australia | Bangladesh | India | Malaysia | Nepal | Canada | Ireland
            | UK | USA | Thailand | Vietnam{" "}
          </h6>
        </div>
      </div>
      <div className="py-1 bg-primaryGreen7 text-primaryGreen2  text-center flex flex-col md:flex-row items-center gap-2 justify-center">
        <span>Copyright© 2024 </span>
        <MyImage
          source="/assets/Logos/LogomarkPurple.png"
          alt="LogomarkPurple.png"
          className="!w-5 mx-2"
          style="width:100px"
        />
