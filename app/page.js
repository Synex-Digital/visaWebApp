          ...
          <div className="mt-28 flex justify-between">
            ...
            <div className="w-7/12 grid grid-cols-2 gap-5">
              <div className="p-7 bg-primary rounded-20px hover:bg-secondary text-white col-span-1">
                <span className="font-semibold text-[38px]">30+</span>
                <h5 className="text-28px my-5">Years of experience</h5>
                <p className="text-lg">
        ...
        <div className="max-w-container mx-auto px-2 text-white">
          ...
          <div className="mt-14 flex justify-between">
            <div className=" text-center w-[20%]">
              <span className="font-semibold text-5xl inline-block">24/7</span>
              <p className="font-semibold text-2xl mt-1">Ready to support</p>
            </div>
            ...
            <div className=" text-center w-[20%]">
              <span className="font-semibold text-5xl inline-block">24/7</span>
              <p className="font-semibold text-2xl mt-1">Best guide for you</p>
            </div>
          </div>
        </div>
      </section>
