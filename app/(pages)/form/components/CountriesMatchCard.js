...
const CountriesMatchCard = ({ id, countryName, flag, onClick, isCardDisabled }) => {
  ...
  return (
    <>
      <button
        ...
        className={`${isCardDisabled? 'cursor-not-allowed': 'cursor-pointer'} col-span-1 h-20 bg-white p-2.5 flex items-center border border-Ash3 rounded-lg relative`}
      >
