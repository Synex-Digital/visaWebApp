...
const SideBar = ({ content }) => {
  return (
    <>
      <div className="w-full md:w-[30%] h-fit  border bg-[#FFF9F9] rounded-20px p-4 sticky top-[4.4rem] md:top-24 overflow-x-scroll scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
